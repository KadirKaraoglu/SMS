...
public class AdminController implements IAdminController {
	...
	@Autowired
	public AdminController(ICourseService courseService, ITeacherService teacherService,IFacultyService facultyService,
	...
	public ResponseEntity<DtoCourse> saveCourse(@RequestBody @Valid DtoCourseUI courseUI) {
	...
	public ResponseEntity<DtoStudent> updateStudent(@RequestBody @Valid DtoStudentUI dtoStudentUI) throws Exception {
	...
	public ResponseEntity<DtoStudent> saveStudent(@RequestBody @Valid DtoStudentUI dtoStudentUI) throws Exception {
	...
	public ResponseEntity<DtoTeacher> updateTeacher(@RequestBody @Valid DtoTeacherUI dtoTeacherUI) throws Exception {
	...
	public ResponseEntity<DtoTeacher> saveTeacher(@RequestBody @Valid DtoTeacherUI dtoTeacherUI) throws Exception {
